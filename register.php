...
<body>
  ...
  <h5 class="my-0 mr-md-auto font-weight-normal">Регистрация</h5>
...
<form  action="model/signup.php" method="post"><br>
  <input type="text" class="form-control" name="name"  placeholder="Введите имя"><br><br>
